/****************************************************************************
 * 🧠 NeuralSearch v6.0 - محرك البــــحث 
...
window.openGuidePage = function(filename, pageNum) {
    ...
    if (isMobile) {
        // الموبايل: استخدام Google Docs Viewer مع تمرير رقم الصفحة في URL
        // لأن #page=X لا يعمل في متصفحات الموبايل
        const fullUrl = window.location.origin + '/' + baseUrl;
        targetUrl = `https://docs.google.com/viewer?url=${encodeURIComponent(fullUrl)}&embedded=false`;
    } else {
